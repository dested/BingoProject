define(['canvasUtils','common.ballGame/pegPhysicsManager'], function (canvasUtils,PegPhysicsManager) {
    ...
    function ClientPegPhysicsManager(gameModel, shouldDraw) {
        this.$super(gameModel);
