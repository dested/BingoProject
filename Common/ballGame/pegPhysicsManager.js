define(
  ...
  function () {
    ...
    function PegPhysicsManager(gameBoard) {
    ...
    PegPhysicsManager.prototype.getBoardWidthInMeters = function () {
      return this.gameBoard.gameModel.boardWidth / this.getMeterPixelSize();
    };
    PegPhysicsManager.prototype.getBoardHeightInMeters = function () {
      return this.gameBoard.gameModel.boardHeight / this.getMeterPixelSize();
    };
